...
export default function ReminderSettings({ settings }: Props) {
    ...
    >
      <div className="space-y-6">
        <label className="flex items-start justify-between gap-6 rounded-2xl bg-[#f8f5f1] p-5">
          <div>
            <h3 className="font-medium text-stone-800">Emlékeztető küldése</h3>

            <p className="mt-1 text-sm leading-6 text-stone-600">
              A rendszer automatikusan emlékeztető e-mailt küld a vendégeknek a foglalás előtt.
            </p>
          </div>
        ...
        <div>
          <label htmlFor="reminderDaysBefore" className="mb-2 block font-medium">
            Hány nappal előtte?
          </label>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              setReminderDaysBefore(Number.isNaN(value) ? 1 : value);
            }}
